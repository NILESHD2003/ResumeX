...
import {
  ProfileService,
  Education_ProfileService,
  Professional_ProfileService,
  Skill_ProfileService,
  Language_ProfileService,
  Certificate_ProfileService,
  Project_ProfileService,
  Award_ProfileService,
  Course_ProfileService,
  Organization_ProfileService,
  Publication_ProfileService,
  Reference_ProfileService,
...
export class ProfileController {
  constructor(
    ...
    private readonly educationProfileService: Education_ProfileService,
    private readonly professionalProfileService: Professional_ProfileService,
    private readonly skillProfileService: Skill_ProfileService,
    private readonly languageProfileService: Language_ProfileService,
    private readonly certificateProfileService: Certificate_ProfileService,
    private readonly projectProfileService: Project_ProfileService,
    private readonly awardProfileService: Award_ProfileService,
    private readonly courseProfileService: Course_ProfileService,
    private readonly organizationProfileService: Organization_ProfileService,
    private readonly publicationProfileService: Publication_ProfileService,
    private readonly referenceProfileService: Reference_ProfileService,
    private readonly declarationProfileService: Declaration_ProfileService,
  ) {}
  ...
  toggleEducationDetailVisibility(
    ...
    return this.educationProfileService.toggleEducationDetailVisibility(
      user.email,
      recordId,
    );
  }
  ...
  removeEducationDetail(
    ...
    return this.educationProfileService.deleteEducationDetail(
      user.email,
      recordId,
    );
  }
  ...
  addProfessionalExperience(
    ...
    return this.professionalProfileService.addProfessionalExperience(
      user.email,
      body,
    );
  }
  ...
  toggleProfessionalExperienceVisibility(
    ...
    return this.professionalProfileService.toggleProfessionalExperienceVisibility(
      user.email,
      recordId,
    );
  }
  ...
  removeProfessionalExperience(
    ...
    return this.professionalProfileService.deleteProfessionalExperience(
      user.email,
      recordId,
    );
  }
  ...
  toggleLanguageVisibility(
    ...
    return this.languageProfileService.toggleLanguageVisibility(
      user.email,
      recordId,
    );
  }
  ...
  toggleCertificateVisibility(
    ...
    return this.certificateProfileService.toggleCertificateVisibility(
      user.email,
      recordId,
    );
  }
  ...
  removeCertificate(
    ...
    return this.certificateProfileService.deleteCertificate(
      user.email,
      recordId,
    );
  }
  ...
  toggleProjectVisibility(
    ...
    return this.projectProfileService.toggleProjectVisibility(
      user.email,
      recordId,
    );
  }
  ...
  toggleCourseVisibility(
    ...
    return this.courseProfileService.toggleCourseVisibility(
      user.email,
      recordId,
    );
  }
  ...
  toggleOrganizationVisibility(
    ...
    return this.organizationProfileService.toggleOrganizationVisibility(
      user.email,
      recordId,
    );
  }
  ...
  removeOrganization(
    ...
    return this.organizationProfileService.deleteOrganization(
      user.email,
      recordId,
    );
  }
  ...
  updatePublication(
    ...
    return this.publicationProfileService.updatePublication(
      user.email,
      recordId,
      body,
    );
  ...
  togglePublicationVisibility(
    ...
    return this.publicationProfileService.togglePublicationVisibility(
      user.email,
      recordId,
    );
  }
  ...
  removePublication(
    ...
    return this.publicationProfileService.deletePublication(
      user.email,
      recordId,
    );
  }
  ...
  updateReferences(
    ...
    return this.referenceProfileService.updateReference(
      user.email,
      recordId,
      body,
    );
  ...
  toggleReferenceVisibility(
    ...
    return this.referenceProfileService.toggleReferenceVisibility(
      user.email,
      recordId,
    );
  }
  ...
  toggleDeclarationVisibility(
    ...
    return this.declarationProfileService.toggleDeclarationVisibility(
      user.email,
    );
  }
  ...
  updateDeclarationSignature(
    ...
    return this.declarationProfileService.updateDeclarationSignature(
      user.email,
      signature,
    );
  }
  ...
  removeDeclarationSignature(
    ...
    return this.declarationProfileService.removeDeclarationSignature(
      user.email,
    );
  }
}

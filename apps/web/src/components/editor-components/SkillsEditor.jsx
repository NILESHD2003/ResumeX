...
const SkillsEditor = ({resumeMetadata, setResumeMetadata}) => {
  const [selectedLayout, setSelectedLayout] = useState(resumeMetadata?.skills?.layout || 'grid');
  const [selectedSubinfoStyle, setSelectedSubinfoStyle] = useState(resumeMetadata?.skills?.subInfoStyle || 'none');
  const [selectedLayoutStyle, setSelectedLayoutStyle] = useState(resumeMetadata?.skills?.layoutInfo || 'two-column');
